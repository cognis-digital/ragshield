#!/usr/bin/env sh
# Universal installer for ragshield. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/ragshield.git"
echo "Installing ragshield ..."
